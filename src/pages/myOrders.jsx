...
import { FaWhatsapp } from "react-icons/fa"; // De Font Awesome
...
export default function MyOrders() {
  ...
  const OrderItem = ({ item, isCustom }) => {
    const image = isCustom
      ? item.imageUrl?.[0]
        ? getDisplayImageUrl(item.imageUrl[0])
        : null
      : item.imageUrl
    ...
    return (
      <div className="flex items-center gap-4 p-3 rounded-xl bg-white/5 border border-white/5 hover:border-white/10 transition-colors">
        <div className="w-32 h-32 rounded-lg overflow-hidden bg-black shrink-0 relative">
          {image ? (
            <img
              src={image}
              alt={title}
        ...
        <div>
          <h4 className="text-sx font-medium text-ice">{title}</h4>
          <p className="text-[12px]  text-white/60 uppercase mb-4 mt-4">
            {subtitle}
          </p>
    ...
    return (
      <div className="min-h-screen bg-blackDeep flex flex-col items-center justify-center px-6 text-center font-['Satoshi']">
        ...
        <p className="text-white/40 text-sm max-w-md mb-8">
          Aquí aparecerán tus proyectos una vez que se haya confirmado el pago.
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <header className="mb-16 text-center sm:text-left">
          ...
          <p className="text-white/70 max-w-2xl text-lg ">
            Gracias por ser parte de nuestra visión. Aquí puedes ver el estado
            de tus piezas exclusivas y los siguientes pasos.
          </p>
        </header>
              ...
              <div className="bg-graphite/20 border border-white/5 backdrop-blur-md rounded-[2rem] overflow-hidden p-6 md:p-10">
                ...
                <div className="flex flex-col md:flex-row justify-between md:items-start gap-6 mb-10 border-b border-white/15 pb-8">
                  <div>
                    <div className="flex flex-wrap items-center gap-4 mb-3">
                      <h3 className="text-2xl text-white font-bold">
                        Orden #{order.idOrder.toString().padStart(4, "0")}
                      </h3>
                      <StatusBadge />
                    </div>
                  ...
                  <div className="text-right">
                    <p className="text-[12px] uppercase tracking-widest text-white/65 mb-1">
                      Total Pagado
                    </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                  ...
                  <div className="lg:col-span-7 space-y-6">
                    <h4 className="text-xs font-bold text-white/65 uppercase tracking-[0.2em] mb-4">
                      Colección Adquirida
                    </h4>
                    ...
                    <div className="bg-gold/5 border border-gold/10 rounded-2xl p-6 relative overflow-hidden">
                      ...
                      <div className="flex items-start gap-3 mb-3">
                        <ShieldCheck
                          ...
                          size={20}
                        />
                        <h5 className="text-gold font-bold uppercase tracking-wider text-sm">
                          Pago Verificado & Seguro
                        </h5>
                      </div>
                      <p className="text-sm text-ice leading-relaxed">
                        Muchas gracias por tu compra. Tu transacción ha sido
                        validada correctamente.
                        <br />
                        <br />
                        <span className="text-white font-medium">
                          Tu producto está oficialmente en preparación.
                        </span>{" "}
                        Queremos transmitirte tranquilidad: nuestro equipo ya
                        tiene los detalles de tu diseño.
                      </p>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="p-5 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] transition-colors">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <div>
                            <p className="text-[12px] uppercase text-white/60 tracking-widest">
                              Técnico Asignado
                            </p>
                        ...
                        <p className="text-sm text-white mb-3 pl-11">
                          Se comunicará contigo cuando tu producto inicie su
                          producción y cuando esté listo.
                        </p>
                        <div className="pl-11 flex flex-col gap-2">
                          {order.user?.email ? (
                            <a
                              href={`https://mail.google.com/mail/?view=cm&fs=1&to=ronygook95@gmail.com&su=${encodeURIComponent(
                                `Consulta del Pedido #${order.idOrder
                                  .toString()
                                  .padStart(4, "0")}`
                              )}&body=${encodeURIComponent(
                                `Hola Rony Gonzales,\n\nNecesito información sobre mi pedido #${order.idOrder
                                  .toString()
                                  .padStart(4, "0")}.`
                              )}`}
                              target="_blank"
                            ...
                            <div className="opacity-30 flex items-center justify-center bg-steel/10 text-steel text-[10px] py-2.5 rounded uppercase">
                              Sin Email
                            </div>
                          )}
                          {order.user?.phone && (
                            <a
                              href={`https://wa.me/3513501278`}
                              target="_blank"
                              rel="noopener noreferrer"
                      ...
                      <div className="p-5 rounded-xl bg-white/[0.02] border border-white/5 flex items-start gap-4">
                        ...
                        <div>
                          <p className="text-[12px] uppercase text-white/60 tracking-widest mb-2">
                            Punto de Retiro
                          </p>
                          <p className="text-sm text-white mb-1">
                            Av. Colón 1234, Oficina 5B
                          </p>
                          <p className="text-sm text-white/70">
                            Córdoba Capital, Argentina
                          </p>
                          <div className="flex items-center gap-2 mt-2 text-[12px] text-green-400/80 bg-green-900/10 w-fit px-2 py-1 rounded">
                            <Clock size={17} />
